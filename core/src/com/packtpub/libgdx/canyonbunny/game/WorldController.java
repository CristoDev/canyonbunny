...
public class WorldController extends InputAdapter {
	...
	// ancienne version de initTestObject avant l'utilisation des textures
	private void initTestObjectsSimple() {
	...
	private void handleDebugInput (float deltaTime) {
		...
		if (Gdx.input.isKeyPressed(Keys.Q)) moveSelectedSprite(
				-sprMoveSpeed, 0);
		if (Gdx.input.isKeyPressed(Keys.D))
			moveSelectedSprite(sprMoveSpeed, 0);
		if (Gdx.input.isKeyPressed(Keys.Z)) moveSelectedSprite(0,
				sprMoveSpeed);
